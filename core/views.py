                ...
                if form.is_valid():
                    ...
                    if use_default_shipping:
                        ...
                        if address_qs.exists():
                            ...
                            messages.info(self.request, 'No default shipping addresses available')
                            return redirect('core:checkout')
                    else:
                    ...
                    if same_billing_address:
                        ...
                        if address_qs.exists():
                            ...
                            messages.info(
                                self.request, 'No default billing addresses available')
                            return redirect('core:checkout')
                    else:
...
class PaymentView(View):
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            use_deafult = form.cleaned_data.get('use_default')
...
def remove_from_cart(request, slug):
    ...
    if order_qs.exists():
        ...
        # add a message saying the user doesnt haven an order
